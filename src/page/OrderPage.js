        ...
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
              ...
              <strong>Municipality: </strong>{order.shippingAddress.city}, <br/>
              <strong>Phone Number: </strong>{order.shippingAddress.postalCode}<br/>
              <strong>Post Code: </strong>{order.shippingAddress.country}
              </Card.Text>
              <h3 variant="danger">Will be delivered soon</h3>
            </Card.Body>
          </Card>
          <Card className="mb-3">
            <Card.Body>
              ...
              {order.isPaid ? (
                <h1 variant="success">Paid at {order.paidAt}</h1>
              ) : (
                <h1 variant="danger">Not Paid</h1>
              )}
            </Card.Body>
          </Card>
